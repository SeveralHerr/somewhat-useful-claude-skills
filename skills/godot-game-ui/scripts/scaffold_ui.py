...
Usage:
    ...
    python scaffold_ui.py . --palette clinical
    python scaffold_ui.py --list-palettes
"""
...
PIECES: dict[str, tuple[str, tuple[str, ...], str]] = {
    ...
    "hud":     ("hud.gd",            ("theme", "motion"), "in-game HUD (stats, prompt, reward card)"),
    "pause":   ("pause_menu.gd",     ("theme", "motion"), "pause overlay with sliders"),
    "title":   ("title_screen.gd",   ("theme", "motion"), "title screen"),
    "results": ("results_screen.gd", ("theme", "motion"), "end-of-run summary + collection grid"),
}
...
def main() -> int:
    ...
    if "ui_theme.gd" in written:
        if args.palette == "amber":
            print(
                ...
                "\n    python scaffold_ui.py . --only theme --palette <name> --force\n"
    ...
    print(
        ...
        "direction -- and once you have added screens of your own, that is checkable\n"
        "rather than a promise:\n"
        f"\n    python palette_lint.py {dest}\n"
        "\n"
        "It names any Color literal a palette change would not reach. That claim was false\n"
        "in four of these files once, and the scaffolder went on making it, which is why\n"
        "there is now a command instead of a sentence.\n"
        "\n"
